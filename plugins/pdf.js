...
const need = "*🌟ᴀᴅᴅ ʟɪɴᴋ ᴀғᴛᴇʀ ᴄɪᴍᴍᴀɴᴅ🌟*"

if (Config.WORKTYPE == 'private') {

  Raashii.addCommand({ pattern: 'pdf ?(.*)', fromMe: true, desc: 'Get screenshot of links in pdf'}, (async (message, match) => {
  ...
  Raashii.addCommand({ pattern: 'pdf ?(.*)', fromMe: false, desc: 'Get screenshot of links in pdf'}, (async (message, match) => {
