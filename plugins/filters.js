...
await message.client.sendMessage(message.jid, fs.readFileSync('./kaztroser/uploads/alive.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        }
