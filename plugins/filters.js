...
const array = ['916282617118','@6282617118','@916282617118','Sed','Hi','@','Admin myr','Andi','Angane','Beach','Beluga','BJP','Boob','Bot evide','Bota','Bro','Cigarette','Colony','come','Comedy','Convert','Dady','Dance','Delete','Drug','Fire','Frek','fuck','Good night','Gun','Hi','I Love you','Insta','ippo','it's time','Kodukk','minnal','Minute','Mp3','My','Myre','Nanba','Niedha','No','nokkate','Odra','OK FINE','Party','Pee','Podaa','Podi','Pooran','sari','Sed','Selfe','Sent','Sex','Show','Smail','song','Suicide','Suii','Thooran','Uff','Why','wow']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
