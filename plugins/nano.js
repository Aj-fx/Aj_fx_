    ...
    if (regex2.test(message.message)) {
        ...
        if (message.reply_message.video === false && message.reply_message.image) {
		    ...
		    await message.client.sendMessage(message.jid,'\n *✔got connection from server and uploading the video* \n',MessageType.text);
                    await message.client.sendMessage(message.jid,fs.readFileSync('status.png'), MessageType.image ,{caption: '```WA STATUS GENERATED BY KAZTRO SER```'  , mimetype: Mimetype.jpg, quoted: message.data,thumbnail: kaztro.tm_b});
            });
        return 
        }
        ...
        ffmpeg(location)
            ...
            .on('end', async () => {
		 await message.client.sendMessage(message.jid,'\n *✔ got connection from server and uploading the video* \n',MessageType.text);
                await message.client.sendMessage(message.jid,fs.readFileSync('st.mp4'), MessageType.video , {caption: '```WA STATUS GENERATED BY KAZTRO SER```'  , mimetype: Mimetype.mp4, quoted: message.data,thumbnail: kaztro.tm_b});
            });
    ...
    if (regex13.test(message.message)) {
        ...
        if (message.reply_message.video === false && message.reply_message.image) {
            ffmpeg(location)
                ...
                .on('end', async () => {
		    await message.client.sendMessage(message.jid,'\n *✔uploading* \n',MessageType.text);
                    await message.client.sendMessage(message.jid,fs.readFileSync('status.png'), MessageType.image ,{caption: '```GENERATED BY KAZTRO SER```'  , mimetype: Mimetype.jpg, quoted: message.data,thumbnail: kaztro.tm_b});
            });
        return 
        }
       else (message.reply_message.video === true && message.reply_message.video) 
        ffmpeg(location)
            ...
            .on('end', async () => {
		 await message.client.sendMessage(message.jid,'\n *✔uploading* \n',MessageType.text);
                await message.client.sendMessage(message.jid,fs.readFileSync('st.mp4'), MessageType.video , {caption: '```GENERATED BY KAZTRO SER```'  , mimetype: Mimetype.mp4, quoted: message.data,thumbnail: kaztro.tm_b});
            });
