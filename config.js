...
module.exports = {
    ...
    KAZTRO_SER: process.env.ALIVE_BUTTON === undefined ? 'Hello/Hii' : process.env.ALIVE_BUTTON,   
    ALIVEONE: process.env.ALIVEBUTTON === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴋᴀᴢᴛʀᴏsᴇʀ࿐' : process.env.ALIVEBUTTON,
    ALIVE_TWO: process.env.ALIVE_BUTTON === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴀᴊғx࿐' : process.env.ALIVE_BUTTON,   
