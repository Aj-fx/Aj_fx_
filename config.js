...
module.exports = {
    ...
    GITMSG: process.env.GIT_MESSAGE === undefined ? 'default' : process.env.GIT_MESSAGE,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/yQWf4ty.jpeg' : process.env.LG_LOGO,
    ...
    AJ_FX: process.env.ALIVE_BUTTON === undefined ? 'sᴇᴅ/ʜᴀᴘᴘʏ' : process.env.ALIVE_BUTTON,   
